...
from sota.cnn.model_search_dartsm import DartsMinusNetwork
from sota.cnn.model_search_sdarts import SDartsNetwork
from sota.cnn.model_search_darts_proj import DartsNetworkProj
from sota.cnn.model_search_dartsm_proj import DartsMinusNetworkProj
...
def main():
    ...
    if args.method in ['darts', 'blank']:
        ...
        model = DartsMinusNetwork(args.init_channels, n_classes, args.layers, criterion, spaces_dict[args.search_space], args)
    ## sdarts
    ...
    ## projection
        ...
        model = DartsMinusNetworkProj(args.init_channels, n_classes, args.layers, criterion, spaces_dict[args.search_space], args)
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        ## darts-
        if args.method in ['darts-', 'blank-']:
            beta_epoch = 1.0 #(args.epochs - epoch -1)/(args.epochs - 1)
