...
parser.add_argument('--resume_epoch', type=int, default=0, help='resume training from epoch')
parser.add_argument('--resume_lr', type=float, default=0.025)
parser.add_argument('--s_time', type=str, default = '', help='time of prev run for resume')
args = parser.parse_args()

if args.resume_epoch > 0:
  args.save = '../experiments/{}/eval-{}-{}-{}-{}'.format(
    args.dataset, args.save, args.s_time, args.arch, args.seed)
else:
  args.save = '../experiments/{}/eval-{}-{}-{}-{}'.format(
...
def main():
  ...
  if args.resume_epoch > 0:
    ...
    sched_state['last_epoch'] = args.resume_epoch
    sched_state['_step_count'] = args.resume_epoch + 1
    sched_state['_last_lr'] = [args.resume_lr]
