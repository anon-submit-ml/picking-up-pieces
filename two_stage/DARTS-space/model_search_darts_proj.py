...
class DartsNetworkProj(Network):
    def __init__(self, C, num_classes, layers, criterion,
                 steps=4, multiplier=4, stem_multiplier=3, k=4):
        super(DartsNetworkProj, self).__init__(C, num_classes, layers, criterion,
              steps=steps, multiplier=multiplier, stem_multiplier=stem_multiplier, k=k)
    ...
    def get_state_dict(self, epoch, optimizer, architect, scheduler):
        model_state_dict = {
    ...
    def set_state_dict(self, optimizer, architect, scheduler, checkpoint):
        #### common
